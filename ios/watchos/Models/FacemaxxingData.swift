...
enum FacemaxxingData {
    static let categories: [String] = protocols.reduce(into: []) { if !$0.contains($1.category) { $0.append($1.category) } }
    ...
    static let protocols: [FacemaxxingProtocol] = [
        ...
        .init(id: "lean", title: "Get Lean", category: "Body", difficulty: "Months",
              ...
              psl: ["Angularity", "Dimorphism"]),
        .init(id: "hairmaxxing", title: "Hair Retention", category: "Hair", difficulty: "Daily",
              ...
              notes: "Hair loss is progressive. Early treatment preserves far more than late treatment.",
              psl: ["Harmony", "Misc"]),
        .init(id: "hairstyle", title: "Hair Styling", category: "Hair", difficulty: "Weekly",
              summary: "Volume and shape at the top of the head lengthen and frame the face.",
              steps: [
                ...
                "Match the fade height to your face shape",
              ],
              notes: "Hair is the largest frame around your face and the fastest thing here to change.",
              psl: ["Harmony", "Misc"]),
        .init(id: "undereye", title: "Undereye Care", category: "Skin", difficulty: "Daily",
              ...
              steps: [
                ...
                "Cold compress for 2 minutes in the morning",
                "Treat allergies, chronic rhinitis causes allergic shiners",
                "Sunscreen and a bland moisturizer, no harsh actives",
              ],
              notes: "Most dark circles are shadow from hollowing or fluid, not pigment.",
              psl: ["Harmony", "Misc"]),
        .init(id: "nasal", title: "Nasal Breathing", category: "Posture", difficulty: "Daily",
              summary: "Mouth breathing drops the jaw, lengthens the midface, and dries the airway.",
              steps: [
                "If you cannot breathe through both nostrils, see an ENT",
                "Nasal strips or dilators at night while you retrain",
                "Saline rinse daily during allergy season",
                "Close the lips and breathe through the nose during light cardio",
              ],
              notes: "Chronic mouth breathing is the mechanism behind poor jaw posture. Mewing sits on top of this.",
              psl: ["Harmony", "Angularity"]),
        .init(id: "teeth", title: "Dental and Bite", category: "Style", difficulty: "Ongoing",
              ...
              steps: [
                ...
                "Ask an orthodontist about crowding or an overbite",
                "Whitening strips for 2 weeks, once a year at most",
                "Fix a chipped or discoloured front tooth before anything else",
              ],
        ...
        .init(id: "neck", title: "Neck Training", category: "Muscle", difficulty: "10 min, 3x/week",
              ...
              steps: [
                ...
                "Two to three sessions per week, never consecutive days",
              ],
              notes: "The neck responds fast and holds the change. Start with bodyweight for the first month.",
              psl: ["Dimorphism", "Angularity"]),
        .init(id: "shoulders", title: "Shoulder Width", category: "Body", difficulty: "3x/week",
              ...
              notes: "Shoulder-to-waist ratio is one of the strongest read-at-a-glance signals.",
              psl: ["Dimorphism"]),
        .init(id: "voice", title: "Voice and Speech", category: "Style", difficulty: "10 min/day",
              ...
              steps: [
                ...
                "Hydrate, and swallow instead of clearing your throat",
              ],
              notes: "Nobody sees your face without also hearing you. Recording is the entire method.",
              psl: ["Dimorphism", "Misc"]),
        .init(id: "actives", title: "Actives Progression", category: "Skin", difficulty: "Nightly",
              ...
              steps: [
                ...
                "Never start two actives in the same month",
              ],
              notes: "Irritation is not progress. Back off the frequency.",
              psl: ["Harmony", "Misc"]),
        .init(id: "cardio", title: "Cardio Base", category: "Recovery", difficulty: "3x/week",
              ...
              steps: [
                ...
                "Do not stack hard cardio on heavy lifting days if recovery is thin",
              ],
              notes: "Better circulation and deeper sleep show up in the face within weeks.",
              psl: ["Harmony", "Misc"]),
        .init(id: "stress", title: "Stress and Cortisol", category: "Recovery", difficulty: "Daily",
              ...
              notes: "If you clench, a night guard comes before any chewing protocol.",
              psl: ["Harmony", "Misc"]),
        .init(id: "photos", title: "Angles and Photos", category: "Style", difficulty: "Once",
              ...
              steps: [
                ...
                "Take a front, three-quarter, and profile shot monthly",
              ],
              notes: "The mirror is reversed and the phone lens is wide. A monthly three-angle set is the only honest record.",
              psl: ["Misc"]),
    ]
}
